...
Давным-давно, когда деревья были большими, трава зеленее, да и я намного моложе, этот ресурс представлял из себя обычный блог, где постепенно накапливались статьи по администрированию **Linux** систем. Статей становилось больше, мои компетенции росли. Если проследить "качество материала", виден переход от разжевывания основ с подробным описанием каждой команды, до краткого описания блока команд и представлением кусков конфигураций. Блог развивался вместе со мной, становился все ближе к изначальной задумке - технической документации и базе знаний по **Linux** системам.
...
Отличительной особенностью системы **Jekyll** является то, что сайт статичен и очень шустро работает. Поиск по сайту моментальный. Все статьи хранятся в **GitHub** в формате **Markdown**. У сайта нет админки, как и нет хостинга.
